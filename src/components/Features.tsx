...
const Features = () => {
  ...
  return <section id="features" className="py-24 px-6 relative">
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {featuresGroups.map((group, groupIndex) => <div key={groupIndex} className="mb-16 last:mb-0">
          ...
          loop: true
              ...
              <CarouselContent>
                {group.features.map((feature, index) => <CarouselItem key={index} className="md:basis-1/3 lg:basis-1/3 pl-4">
