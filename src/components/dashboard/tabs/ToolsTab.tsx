  ...
  return <div className="space-y-12 w-full pb-12">
    ...
    <section className='space-y-6'>
      ...
      <div className="mt-2 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 auto-rows-fr">
        <Card className="h-[16rem] group relative pb-2 flex flex-col justify-center rounded-2xl bg-gray-200 pl-3 pr-3 shadow-sm ring-0 ring-gray-200 transition-all duration-150 hover:shadow-lg hover:ring-2 hover:ring-white focus:shadow-xl focus:ring-gray-600 dark:bg-gray-700 dark:hover:ring-gray-300 dark:focus:ring-gray-400 bg-[#384454]" onClick={() => handleCardClick("Veille des Appels d'Offres", false)}>
          <CardHeader className="pb-3 relative pt-0">
            <div className="flex flex-row items-center justify-between mb-3">
              ...
              <button className="flex justify-center text-gray-400 hover:text-neon-blue" title='Ajouter aux favoris' onClick={(e) => {
                e.stopPropagation();
                addToFavorites({
        ...
        <Card className="h-[16rem] group relative pb-2 flex flex-col justify-center rounded-2xl bg-gray-200 pl-3 pr-3 shadow-sm ring-0 ring-gray-200 transition-all duration-150 hover:shadow-lg hover:ring-2 hover:ring-white focus:shadow-xl focus:ring-gray-600 dark:bg-gray-700 dark:hover:ring-gray-300 dark:focus:ring-gray-400 bg-[#384454]" onClick={() => handleCardClick("Analyse rapide du DCE", false)}>
          <CardHeader className="pb-3 relative pt-0">
            <div className="flex flex-row items-center justify-between mb-3">
              <div className="flex h-12 w-12 bg-neon-blue/20 rounded-lg items-center justify-center group-hover:bg-neon-blue/30 transition-colors">
                <div className="text-neon-blue">
        ...
        <Card className="h-[16rem] group relative pb-2 flex flex-col justify-center rounded-2xl bg-gray-200 pl-3 pr-3 shadow-sm ring-0 ring-gray-200 transition-all duration-150 hover:shadow-lg hover:ring-2 hover:ring-white focus:shadow-xl focus:ring-gray-600 dark:bg-gray-700 dark:hover:ring-gray-300 dark:focus:ring-gray-400 bg-[#384454]" onClick={() => handleCardClick("Evaluation d'une étude", false)}>
          <CardHeader className="pb-3 relative pt-0">
            <div className="flex flex-row items-center justify-between mb-3">
              <div className="flex h-12 w-12 bg-neon-blue/20 rounded-lg items-center justify-center group-hover:bg-neon-blue/30 transition-colors">
                <div className="text-neon-blue">
            ...
            <Badge className="absolute top-3 right-3" variant="coming">A venir</Badge>
