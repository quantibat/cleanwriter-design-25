...
const EditDCE = () => {
  ...
  const getInitialFormValues = () => {
    ...
    return {
      ...
      sourceMaterials: '',  // This field might not exist in projectData
      category: 'technique', // Default value, adjust as needed
      subcategory: 'CCTP',  // Default value, adjust as needed
      language: 'french',
      format: 'pdf',
  ...
  // Catégories et sous-catégories pour les documents techniques
  const categories = {
  ...
  // Options disponibles pour la sous-catégorie en fonction de la catégorie sélectionnée
