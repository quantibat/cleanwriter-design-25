  ...
  return (
    <DashboardLayout activeTab="account" breadcrumbs={[{ label: 'Mon Compte', path:'/account' }, { label: activeTab === 'profile' ? 'Informations personnelles' : activeTab === 'enterprise' ? 'Entreprise' : 'Sécurité' }]} toolType="account">
      <div className="flex flex-col w-full mt-4">
        <div className='w-full bg-gradient-to-b from-gray-700 to-gray-800 border-[#384454] border backdrop-blur-lg p-6 rounded-lg shadow-lg border border-[#384454] mb-8'>
        ...
        <div className='flex flex-col md:flex-row gap-8 w-full'>
          <aside className="w-full md:w-64 space-y-2 pr-4">
            <button
              ...
              className={cn(
                "w-full text-left px-4 py-2 rounded-md transition border border-gray/20 bg-gradient-to-b from-gray-700 to-gray-800 text-sm",
                activeTab === 'profile' ? "bg-blue-600 font-semibold" : "hover:bg-accent"
              )}
            >
            ...
            <button
              ...
              className={cn(
                "w-full text-left px-4 py-2 rounded-md transition border border-gray/20 bg-gradient-to-b from-gray-700 to-gray-800 text-sm",
                activeTab === 'enterprise' ? "bg-blue-600 font-semibold" : "hover:bg-accent"
              )}
            >
              Entreprise
            </button>
            <button
              ...
              className={cn(
                "w-full text-left px-4 py-2 rounded-md transition border border-gray/20 bg-gradient-to-b from-gray-700 to-gray-800 text-sm",
                activeTab === 'security' ? "bg-blue-600 font-semibold" : "hover:bg-accent"
              )}
            >
              Sécurité
            </button>
